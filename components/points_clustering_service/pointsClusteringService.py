...
class PointsClusteringService:
    ...
    def __init__(self):
        self._eps: float = 200  # The maximum distance between two samples for one to be considered as in the
        ...
        self._min_samples: int = 12  # The number of samples (or total weight) in a neighborhood for a point to be
